...
namespace Game.Core
{
    ...
    public partial class LoggingServiceConfig : ScriptableObject
    {
        ...
        {
            // ALCHEMY BUG FIX:
            // Alchemy's reflection-based dictionary field does not reliably mark ScriptableObjects
            // dirty after adding an entry.
            // Flush its generated JSON explicitly before the inspector releases this asset.
